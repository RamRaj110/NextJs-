          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <div className="relative rounded-full border-2 border-primary/30 p-2 bg-background/50 backdrop-blur-sm">
                  <Image
        ...
        <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-right duration-700">
          ...
          <div className="lg:hidden flex flex-col items-center space-y-3 text-center mb-8">
            <div className="relative">
              ...
              <div className="relative rounded-full border-2 border-border/50 p-1">
                <Image
                  className="rounded-full object-cover"
                  src="/logo.png"
                  alt="Logo"
